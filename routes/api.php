...
Route::prefix('/v1/company/')->group(function(){
    Route::group(['middleware' => ['jwt.auth','getUserFromToken']],function(){
        Route::post('create', 'CompanyController@createCompany')->middleware('user.access:admin');
...
Route::prefix('/v1/employee/')->group(function(){
    Route::group(['middleware' => ['jwt.auth','getUserFromToken']],function(){
        ...
        Route::post('upload-photo', 'EmployeeController@uploadPic')->middleware('user.access:admin,employee');
        ...
        Route::put('update', 'EmployeeController@updateEmployee')->middleware('user.access:admin');
        Route::put('update-profile', 'EmployeeController@updateEmployeeProfile')->middleware('user.access:employee');
