...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateUser: function updateUser() {
      ...
      _repository_users_EmployeeRepository__WEBPACK_IMPORTED_MODULE_0__["default"].updateUser(this.model).then(function (res) {
        _this.getUser();
    ...
    getUser: function getUser() {
      ...
      _repository_users_EmployeeRepository__WEBPACK_IMPORTED_MODULE_0__["default"].getProfile().then(function (res) {
    ...
    onSelectedPhoto: function onSelectedPhoto(e) {
      ...
      _repository_users_EmployeeRepository__WEBPACK_IMPORTED_MODULE_0__["default"].uploadPhoto(data).then(function (res) {
        _this3.$notify({
          type: 'success',
